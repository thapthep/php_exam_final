  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12"> <br>
        <h3>รายชื่อลูกค้า <a href="addsickcustomer.php" class="btn btn-info float-end">+เพิ่มข้อมูล</a> </h3>
          ...
          <tbody>
            ...
            foreach ($result as $r) { ?>
              <tr>
                ...
                <td><a href="updateform.php" class="btn btn-warning btn-sm">แก้ไข</a></td>
